  ...
  */
   ...
   */
		...
		value: function confirmMfa(_ref4) {
			var auth = _ref4.auth,
			    mfa_token = _ref4.mfaToken,
			    otp = _ref4.otp,
			    context = _ref4.context;

			return this.post('/v1/user/mfa-enable', { mfa_token: mfa_token, otp: otp }, auth, context);
		}
   ...
   */
		...
		value: function disableMfa(_ref5) {
			var auth = _ref5.auth,
			    current_password = _ref5.currentPassword,
			    context = _ref5.context;

			return this.put('/v1/user/mfa-disable', { current_password: current_password }, auth, context);
		}
   ...
   */
		...
		value: function listAccessTokens(_ref13) {
   ...
   */
		...
		value: function trackingIdentity() {
			var _ref14 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
			    auth = _ref14.auth,
			    _ref14$full = _ref14.full,
			    full = _ref14$full === undefined ? false : _ref14$full,
   ...
   */
		...
		key: 'listDevices',
		value: function listDevices(_ref15) {
			var deviceId = _ref15.deviceId,
			    deviceName = _ref15.deviceName,
			    sortAttr = _ref15.sortAttr,
			    sortDir = _ref15.sortDir,
			    page = _ref15.page,
   ...
   */
		...
		key: 'getDevice',
		value: function getDevice(_ref16) {
   ...
   */
		...
		key: 'claimDevice',
		value: function claimDevice(_ref17) {
			var deviceId = _ref17.deviceId,
			    requestTransfer = _ref17.requestTransfer,
			    auth = _ref17.auth,
   ...
   */
		...
		value: function addDeviceToProduct(_ref18) {
   ...
   */
		...
		key: 'removeDevice',
		value: function removeDevice(_ref19) {
   ...
   */
		...
		value: function removeDeviceOwner(_ref20) {
   ...
   */
		...
		key: 'renameDevice',
		value: function renameDevice(_ref21) {
   ...
   */
		...
		key: 'signalDevice',
		value: function signalDevice(_ref22) {
   ...
   */
		...
		key: 'setDeviceNotes',
		value: function setDeviceNotes(_ref23) {
   ...
   */
		...
		value: function markAsDevelopmentDevice(_ref24) {
			var deviceId = _ref24.deviceId,
			    _ref24$development = _ref24.development,
			    development = _ref24$development === undefined ? true : _ref24$development,
   ...
   */
		...
		value: function lockDeviceProductFirmware(_ref25) {
			var deviceId = _ref25.deviceId,
			    desiredFirmwareVersion = _ref25.desiredFirmwareVersion,
			    flash = _ref25.flash,
   ...
   */
		...
		value: function unlockDeviceProductFirmware(_ref26) {
   ...
   */
		...
		key: 'updateDevice',
		value: function updateDevice(_ref27) {
			var deviceId = _ref27.deviceId,
			    name = _ref27.name,
			    signal = _ref27.signal,
			    notes = _ref27.notes,
			    development = _ref27.development,
   ...
   */
		...
		key: 'provisionDevice',
		value: function provisionDevice(_ref28) {
			var productId = _ref28.productId,
			    auth = _ref28.auth,
   ...
   */
		...
		key: 'getClaimCode',
		value: function getClaimCode(_ref29) {
		...
		value: function validatePromoCode(_ref30) {
			var auth = _ref30.auth,
			    promoCode = _ref30.promoCode,
		...
		key: 'changeProduct',
		value: function changeProduct(_ref31) {
			var deviceId = _ref31.deviceId,
			    productId = _ref31.productId,
			    auth = _ref31.auth,
   ...
   */
		...
		key: 'getVariable',
		value: function getVariable(_ref32) {
   ...
   */
		...
		key: 'flashDevice',
		value: function flashDevice(_ref33) {
   ...
   */
		...
		key: 'flashTinker',
		value: function flashTinker(_ref34) {
   ...
   */
		...
		key: 'compileCode',
		value: function compileCode(_ref35) {
			var files = _ref35.files,
			    platformId = _ref35.platformId,
   ...
   */
		...
		value: function downloadFirmwareBinary(_ref36) {
			var binaryId = _ref36.binaryId,
			    auth = _ref36.auth,
   ...
   */
		...
		key: 'sendPublicKey',
		value: function sendPublicKey(_ref37) {
			var deviceId = _ref37.deviceId,
			    key = _ref37.key,
			    algorithm = _ref37.algorithm,
			    auth = _ref37.auth,
   ...
   */
		...
		key: 'callFunction',
		value: function callFunction(_ref38) {
			var deviceId = _ref38.deviceId,
			    name = _ref38.name,
			    argument = _ref38.argument,
   ...
   */
		...
		key: 'getEventStream',
		value: function getEventStream(_ref39) {
   ...
   */
		...
		key: 'publishEvent',
		value: function publishEvent(_ref40) {
			var name = _ref40.name,
			    data = _ref40.data,
			    isPrivate = _ref40.isPrivate,
   ...
   */
		...
		key: 'createWebhook',
		value: function createWebhook(_ref41) {
			var deviceId = _ref41.deviceId,
			    name = _ref41.name,
			    url = _ref41.url,
			    requestType = _ref41.requestType,
			    headers = _ref41.headers,
			    json = _ref41.json,
			    query = _ref41.query,
			    body = _ref41.body,
			    responseTemplate = _ref41.responseTemplate,
			    responseTopic = _ref41.responseTopic,
			    rejectUnauthorized = _ref41.rejectUnauthorized,
			    webhookAuth = _ref41.webhookAuth,
			    noDefaults = _ref41.noDefaults,
			    form = _ref41.form,
   ...
   */
		...
		key: 'deleteWebhook',
		value: function deleteWebhook(_ref42) {
			var hookId = _ref42.hookId,
   ...
   */
		...
		key: 'listWebhooks',
		value: function listWebhooks(_ref43) {
			var product = _ref43.product,
			    auth = _ref43.auth,
   ...
   */
		...
		value: function createIntegration(_ref44) {
			var integrationType = _ref44.integrationType,
			    event = _ref44.event,
			    settings = _ref44.settings,
   ...
   */
		...
		key: 'editIntegration',
		value: function editIntegration(_ref45) {
			var integrationId = _ref45.integrationId,
			    event = _ref45.event,
   ...
   */
		...
		value: function deleteIntegration(_ref46) {
   ...
   */
		...
		value: function listIntegrations(_ref47) {
			var product = _ref47.product,
			    auth = _ref47.auth,
   ...
   */
		...
		key: 'getUserInfo',
		value: function getUserInfo(_ref48) {
			var auth = _ref48.auth,
   ...
   */
		...
		key: 'setUserInfo',
		value: function setUserInfo(_ref49) {
			var accountInfo = _ref49.accountInfo,
			    auth = _ref49.auth,
   ...
   */
		...
		key: 'changeUsername',
		value: function changeUsername(_ref50) {
			var currentPassword = _ref50.currentPassword,
			    username = _ref50.username,
			    auth = _ref50.auth,
   ...
   */
		...
		value: function changeUserPassword(_ref51) {
			var currentPassword = _ref51.currentPassword,
			    password = _ref51.password,
			    auth = _ref51.auth,
   ...
   */
		...
		key: 'listSIMs',
		value: function listSIMs(_ref52) {
			var iccid = _ref52.iccid,
			    deviceId = _ref52.deviceId,
			    deviceName = _ref52.deviceName,
			    page = _ref52.page,
			    perPage = _ref52.perPage,
   ...
   */
		...
		key: 'getSIMDataUsage',
		value: function getSIMDataUsage(_ref53) {
   ...
   */
		...
		value: function getFleetDataUsage(_ref54) {
			var product = _ref54.product,
			    auth = _ref54.auth,
		...
		key: 'checkSIM',
		value: function checkSIM(_ref55) {
   ...
   */
		...
		key: 'activateSIM',
		value: function activateSIM(_ref56) {
			var iccid = _ref56.iccid,
			    iccids = _ref56.iccids,
			    country = _ref56.country,
			    promoCode = _ref56.promoCode,
			    product = _ref56.product,
			    auth = _ref56.auth,
   ...
   */
		...
		key: 'deactivateSIM',
		value: function deactivateSIM(_ref57) {
   ...
   */
		...
		key: 'reactivateSIM',
		value: function reactivateSIM(_ref58) {
			var iccid = _ref58.iccid,
			    mbLimit = _ref58.mbLimit,
   ...
   */
		...
		key: 'updateSIM',
		value: function updateSIM(_ref59) {
   ...
   */
		...
		key: 'removeSIM',
		value: function removeSIM(_ref60) {
   ...
   */
		...
		value: function listBuildTargets(_ref61) {
			var onlyFeatured = _ref61.onlyFeatured,
			    auth = _ref61.auth,
   ...
   */
		...
		key: 'listLibraries',
		value: function listLibraries(_ref62) {
			var page = _ref62.page,
			    limit = _ref62.limit,
			    filter = _ref62.filter,
			    sort = _ref62.sort,
			    architectures = _ref62.architectures,
			    category = _ref62.category,
			    scope = _ref62.scope,
			    excludeScopes = _ref62.excludeScopes,
			    auth = _ref62.auth,
   ...
   */
		...
		key: 'getLibrary',
		value: function getLibrary(_ref63) {
   ...
   */
		...
		value: function getLibraryVersions(_ref64) {
   ...
   */
		...
		value: function contributeLibrary(_ref65) {
			var archive = _ref65.archive,
			    auth = _ref65.auth,
   ...
   */
		...
		key: 'publishLibrary',
		value: function publishLibrary(_ref66) {
   ...
   */
		...
		key: 'deleteLibrary',
		value: function deleteLibrary(_ref67) {
   ...
   */
		...
		value: function listOAuthClients(_ref69) {
			var product = _ref69.product,
			    auth = _ref69.auth,
   ...
   */
		...
		value: function createOAuthClient(_ref70) {
			var name = _ref70.name,
			    type = _ref70.type,
			    redirect_uri = _ref70.redirect_uri,
			    scope = _ref70.scope,
   ...
   */
		...
		value: function updateOAuthClient(_ref71) {
			var clientId = _ref71.clientId,
			    name = _ref71.name,
			    scope = _ref71.scope,
   ...
   */
		...
		value: function deleteOAuthClient(_ref72) {
   ...
   */
		...
		key: 'listProducts',
		value: function listProducts(_ref73) {
			var auth = _ref73.auth,
   ...
   */
		...
		key: 'getProduct',
		value: function getProduct(_ref74) {
			var product = _ref74.product,
			    auth = _ref74.auth,
   ...
   */
		...
		value: function listProductFirmware(_ref75) {
   ...
   */
		...
		value: function uploadProductFirmware(_ref76) {
			var file = _ref76.file,
			    version = _ref76.version,
			    title = _ref76.title,
			    description = _ref76.description,
   ...
   */
		...
		value: function getProductFirmware(_ref77) {
			var version = _ref77.version,
   ...
   */
		...
		value: function updateProductFirmware(_ref78) {
   ...
   */
		...
		value: function downloadProductFirmware(_ref79) {
   ...
   */
		...
		value: function releaseProductFirmware(_ref80) {
   ...
   */
		...
		key: 'listTeamMembers',
		value: function listTeamMembers(_ref81) {
			var product = _ref81.product,
			    auth = _ref81.auth,
   ...
   */
		...
		value: function inviteTeamMember(_ref82) {
			var username = _ref82.username,
   ...
   */
		...
		value: function removeTeamMember(_ref83) {
   ...
   */
		...
		value: function lookupSerialNumber(_ref84) {
			var serialNumber = _ref84.serialNumber,
			    auth = _ref84.auth,
   ...
   */
		...
		key: 'deviceUri',
		value: function deviceUri(_ref85) {
			var deviceId = _ref85.deviceId,
